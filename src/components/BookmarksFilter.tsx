...
export const BookmarksFilter: FC<Props> = ({ variant }) => {
    ...
    return (
        <div
            ref={componentRef}
            className="min-w-max bg-bgColor flex items-stretch justify-start border border-borderColor p-5 rounded-lg text-textOnBackgroundColor flex-col relative shadow-xl shadow-shadowColor md:p-6 lg:p-8"
        >
            <div
            ...
            <div className="flex flex-col items-start justify-start text-left">
                <span className="mx-auto md:mx-0">Category:</span>
